let FM = (function(){
	...
	let cvs, audioContext, analyser, audioSource, frequencyData;
	...
	const DOM = {
        ...
        album: document.querySelectorAll('.album')[0],
    ...
    function eventsHandler() {
    	...
    	DOM.playBtn.onclick = function(e){
            ...
            DOM.album.style.animationPlayState = '';
    	}
    	DOM.pauseBtn.onclick = function(e){
    		DOM.audio.pause();
    		DOM.pauseBtn.style.display = 'none';
    		DOM.playBtn.style.display = 'inline-block';
            DOM.album.style.animationPlayState = 'paused';
    	}
    	DOM.likeBtn.onclick = function(e){
    		liked = !liked;
    		if(!liked) {
    	...
    	DOM.progress.onclick = function(e){
    		let x = e.clientX - DOM.progress.offsetLeft - DOM.progress.offsetParent.offsetLeft;
    	...
    	DOM.volumeSlider.onclick = function(e){
            let x = e.offsetX;
    		console.log(x);
    			DOM.volumeSlider.firstChild.style.width = x  + 'px';
    			DOM.audio.volume = x/50;
    	}
    }
	...
	function showTime(){
	    if (DOM.audio.duration) {
	        ...
	        DOM.progressBar.style.width = ((1-timeLeft/totalTime)*100)+'%';
